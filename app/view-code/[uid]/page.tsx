  ...
  const GenerateCode = async (record: any) => {
    ...
    try {
      ...
      while (true) {
        ...
        console.log(`Chunk ${chunkIndex}: done = ${done}, value = ${value}`);
        if (done) {
        ...
        try {
          ...
          console.error(
            `Error decoding or processing chunk ${chunkIndex}:`,
            error
          );
          break;
        }
    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 p-5 gap-10">
        ...
        <div className="col-span-4">
          {loading ? (
            <div className="font-bold text-2xl text-center p-20 bg-slate-100 flex items-center justify-center h-[80vh] rounded-xl">
